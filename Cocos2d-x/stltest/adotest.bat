...
Set VC2012ROOT=C:\Program Files (x86)\Microsoft Visual Studio 11.0
Set VCROOT=C:\Program Files (x86)\Microsoft Visual Studio 8
Set PATH=%VCROOT%\VC\bin;%VCROOT%\Common7\IDE;%PATH%
Set INCLUDE=%VCROOT%\VC\PlatformSDK\include;%VCROOT%\VC\atlmfc\include;%VCROOT%\VC\include;%INCLUDE%
