...
public:
     ...
     */
	virtual int executeAddImageAsyncCallBack(void *,const char*){return 0;};
	virtual int executeGlobalFunction(const char* functionName) { return 0; }
	virtual int executeGlobalFunction(const char* functionName,int numArgs) {return 0;};
	virtual int executeKeyMessage(const char* functionName,unsigned int message,unsigned int wParam,long lParam){return 0;};
