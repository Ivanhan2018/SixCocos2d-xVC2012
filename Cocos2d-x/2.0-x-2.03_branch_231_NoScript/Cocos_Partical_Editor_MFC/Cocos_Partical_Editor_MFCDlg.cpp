...
BOOL CCos_Partical_Editor::OnInitDialog()
{
	...
	dlg_modeA->MoveWindow(0,355,704,190);
	dlg_modeB->MoveWindow(0,355,704,190);
...
void CCos_Partical_Editor::OnOK()
{
...
{
	//Notice: Stop Cocos2d Main loop to release. Just use Cocos2d Method Under MFC in Any Where!
...
void CCos_Partical_Editor::Set()
{
	...
	if(!ptr)
		return;
	CCParticleSystemQuad* particals = (CCParticleSystemQuad*)ptr->getChildByTag(2);
...
void CCos_Partical_Editor::OnBnClickedSave()
{
	...
	AddXMLContent(dictElement,1,"finishColorAlpha",particals->getStartColor().a);
	AddXMLContent(dictElement,1,"finishColorBlue",particals->getStartColor().b);
	AddXMLContent(dictElement,1,"finishColorGreen",particals->getStartColor().g);
	AddXMLContent(dictElement,1,"finishColorRed",particals->getStartColor().r);
	...
	AddXMLContent(dictElement,2,"textureFileName",(float)(int)(LPCSTR)(Utility::UnicodeToUtf8(m_StrPath).c_str()));
