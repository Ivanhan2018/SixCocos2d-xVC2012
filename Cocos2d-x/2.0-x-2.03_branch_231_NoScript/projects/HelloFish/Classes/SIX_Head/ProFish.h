...
enum PROTOCOL_FISH
{
	TABLE_SUB_BUY_BULLET				= 210,	// 购买子弹			// add by cxf
	TABLE_SUB_BUY_BULLET_RET			= 220,	// 购买子弹返回		// add by cxf
	TABLE_SUB_EXCHANGE_INFO_RET			= 250,	// 返回兑换信息		// add by cxf
	//TABLE_SUB_USER_INFO					= 260,	// 用户信息			// add by cxf
	TABLE_SUB_SITDOWN_FINISH			= 270,	// 坐桌完成			// add by cxf
	TABLE_SUB_USER_OVERTIME				= 271,	// 用户超时退出		// add by cxf
...
// 子弹反射
struct BULLET_REFLECTION : public DATA_BASE<BULLET_REFLECTION>
{
	BULLET_REFLECTION()
	{	
		memset(this, 0, sizeof(*this)); 
...
/// 服务器保存的子弹数据
struct BULLET_DATA : public DATA_BASE<BULLET_DATA>
{
