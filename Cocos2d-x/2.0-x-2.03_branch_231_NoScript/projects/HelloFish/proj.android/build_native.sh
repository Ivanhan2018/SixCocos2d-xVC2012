# set params
NDK_ROOT_LOCAL=/cygdrive/f/android-ndk-r9
COCOS2DX_ROOT_LOCAL=/cygdrive/f/SixCocos2d-xVC2012/Cocos2d-x/2.0-x-2.03_branch_231_NoScript
...
HELLOWORLD_ROOT=$COCOS2DX_ROOT_LOCAL/projects/HelloFish/proj.android
...
# copy resources
for file in $COCOS2DX_ROOT_LOCAL/projects/HelloFish/Resources/*
do
if [ -d $file ]; then
