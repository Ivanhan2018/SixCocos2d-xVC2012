...
INTERFACE_BEGIN_BASED(SIX_DataSet,SIX_KV)
	CONSTRUCTOR(SIX_DataSet,pDataElement=new SIX_DSTPL<SIX_KV>;pDataElement->retain(););
...
INTERFACE_BEGIN_BASED(SIX_XmlDataSet,SIX_DataSet)
	CONSTRUCTOR(SIX_XmlDataSet,pNode=new SIX_DSTPL<SIX_XmlDataSet>;pNode->retain(););
	DESTRUCTOR(SIX_XmlDataSet,CC_SAFE_RELEASE(pNode););
