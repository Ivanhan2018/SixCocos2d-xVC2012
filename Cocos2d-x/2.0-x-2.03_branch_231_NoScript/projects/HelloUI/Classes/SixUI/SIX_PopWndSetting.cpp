...
void SIX_PopWndSetting::onEnterTransitionDidFinish()
{
	...
	if (!pScrollBarAudio)
	{
		...
		pScrollBarAudio=SIX_ScrollBar::create(bgSprite,CCRect(0,0,236,25),progressSprite,progressSprite/*thumbSprite*/,thumbSelectSprite,true);
	...
	if (!pScrollBarEffect)
	{
		...
		CCScale9Sprite *thumbSprite = CCScale9Sprite::create("Common/Setting/volume.png",CCRect(0,0,41,46));
		CCScale9Sprite *thumbSelectSprite = CCScale9Sprite::create("Common/Setting/volume.png",CCRect(41,0,41,46));
		pScrollBarEffect = SIX_ScrollBar::create(bgSprite,CCRect(236,25,0,0),progressSprite,progressSprite/*thumbSprite*/,thumbSelectSprite,true);
