...
struct tagPropertyInfo
{
	//道具信息
	_WORD_							wIndex;								//道具标识
	_WORD_							wDiscount;							//会员折扣
	_WORD_							wIssueArea;							//发布范围
...
{
	_WORD_							wIndex;								//道具标识
	_WORD_                            wPropertyType;                      //道具类型
	_WORD_							wServiceArea;						//使用范围
	_TCHAR_                           szMeasuringunit[8];					//计量单位
	_TCHAR_							szPropertyName[32];					//道具名字
	_TCHAR_							szRegulationsInfo[256];				//使用信息
};
