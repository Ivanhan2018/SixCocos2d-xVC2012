...
public:
	...
	void setUserMessage(CCInteger * obj);		//玩家信息
	void setTimesMessage(CMD_S_GameEnd* _gameEnd,WORD _userID);	//设置倍率信息
private:
	void addString(char* key,CCPoint point,_ccColor3B  color,int fontSize,int tag,int num);		//添加要显示的字符串
