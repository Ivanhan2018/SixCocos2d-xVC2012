...
//消息加密映射表
//static const BYTE g_dwPacketKey=0xA55A55A;
...
const
BYTE g_RecvByteMap[256] = {	0x51, 0xA1, 0x9E, 0xB0, 0x1E, 0x83,
...
//
//const char szCompilatio[]="F79DF00B-C437-41C5-AF93-24763A939B29";
...
//通用验证 演示平台验证
//const char szCompilatio[]="8C3AC3BC-EB40-462f-B436-4BBB141FC7F9";

bool Common_Compilation(TCHART *data)
{	
	MyNSString::mbs2wc(szCompilatio, sizeof(szCompilatio), data);
	//memcpy(data, szCompilatio, sizeof(szCompilatio));
	return true;
}
