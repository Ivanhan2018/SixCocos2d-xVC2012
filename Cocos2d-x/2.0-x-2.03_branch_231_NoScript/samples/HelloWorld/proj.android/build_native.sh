...
COCOS2DX_ROOT_LOCAL=/cygdrive/e/2.0-x-2.03
...
HELLOWORLD_ROOT=$COCOS2DX_ROOT_LOCAL/samples/HelloWorld/proj.android
...
# copy resources
for file in $COCOS2DX_ROOT_LOCAL/samples/HelloWorld/Resources/*
do
if [ -d $file ]; then
