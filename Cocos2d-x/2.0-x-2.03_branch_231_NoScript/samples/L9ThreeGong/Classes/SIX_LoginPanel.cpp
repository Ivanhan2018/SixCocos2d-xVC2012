...
void SIX_LoginPanel::showLoginTips(const char *msg)
{
	if (!pLabelLoginTips)
		return;
...
void SIX_LoginPanel::showRegTips(const char *msg)
{
	if (!pLabelRegTips)
		return;
...
bool SIX_LoginPanel::DoRegister()
{
	this->DoLockPanel(true);
...
void SIX_LoginPanel::DoShowLogin(bool bShow)
{
	if (pLabelLogin)
...
void SIX_LoginPanel::DoShowReset(bool bShow)
{
	if (pLabelLogin)
		pLabelLogin->setVisible(!bShow);
	if (pLabelReset)
...
void SIX_LoginPanel::DoShowReg(bool bShow)
{
	if (pLabelLogin)
		pLabelLogin->setVisible(!bShow);
	if (pLabelReset)
...
void SIX_LoginPanel::DoShowEditBox(SIX_EditBox *pEditBox,bool bShow)
{
	if (!pEditBox)
		return;
...
void SIX_LoginPanel::onHideFinished()
{
