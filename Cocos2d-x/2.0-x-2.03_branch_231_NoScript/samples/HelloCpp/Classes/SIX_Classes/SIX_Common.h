...
// 子弹发射延迟间隔(ms)
#define BULLET_SHOOT_DELAY	400
// 子弹连续发射等待时间，最好大于子弹发射延迟间隔 BULLET_SHOOT_DELAY
#define BULLET_REPEATSHOOT_DELAY 500
...
#define WLOG(fmt,...)		SIX_GlobalMgr::GetInstance()->GetLogger()->WriteToFile("%s",##fmt,##__VA_ARGS__);
