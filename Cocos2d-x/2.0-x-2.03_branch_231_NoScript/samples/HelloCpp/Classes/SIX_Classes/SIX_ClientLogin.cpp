...
void SIX_ClientLogin::Connect(bool bReconnected,int iReconnectDelay)
{
	...
	m_gClientLogin->init((char*)(SIX_GlobalMgr::GetInstance()->GetConfig()->ip.c_str()),SIX_GlobalMgr::GetInstance()->GetConfig()->port,SIX_PlayerMgr::GetInstance()->getMyName(),SIX_PlayerMgr::GetInstance()->getMyPass());
