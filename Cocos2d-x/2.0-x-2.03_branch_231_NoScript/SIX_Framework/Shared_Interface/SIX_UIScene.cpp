...
// 设置键（暂未实现）
void SIX_UIScene::keyMenuClicked()
{

}

// 返回键
// 实现具有Yes/No功能的Dialog，增加回调接口返回给C++处理；
// C++原型：void MsgBoxYesOrNo(const char *)
// Yes=确定退出
// No=Dialog dismiss
// Cool.Cat
void SIX_UIScene::keyBackClicked()
{
	SIX_CCJNIHelper::GetInstance()->showMsgBoxYesOrNoJNI("确定退出？");
}