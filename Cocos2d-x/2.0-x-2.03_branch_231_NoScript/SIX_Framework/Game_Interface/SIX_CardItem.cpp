...
// 视角翻转
void SIX_CardItem::setCardOrbitCamera(float t,float angleZ,float deltaAngleZ)
{
	this->runAction(CCSequence::create(CCOrbitCamera::create(t,1.0f,0.0f,angleZ,deltaAngleZ,0.0f,0.0f),0));
}
