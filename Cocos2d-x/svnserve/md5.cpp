...
ERROR_INFO HashByMD5(char *pSrc,unsigned sLen,char *pDst,bool upper,unsigned power,char *slot)
{
	if (!pSrc)
...
void MakeMD5(char *src,char *dst,bool upper,int repeat)
{
...
char *MD5::hex_digest(char buffer[33],bool upper){
