...
//生成密文
unsigned short CXOREncrypt::EncryptData(const char* pszSrcData, char* pszEncrypData, unsigned short wSize)
{
	//效验参数
	assert(wSize>0);
...
//解开密文
unsigned short CXOREncrypt::CrevasseData(const char* pszEncrypData, char* pszSrcData, unsigned short wSize)
{
	//效验参数
	assert(wSize>0);
	assert(pszSrcData!=NULL);
