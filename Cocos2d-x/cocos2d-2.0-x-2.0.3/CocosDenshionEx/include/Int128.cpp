...
// unsigned long
CHSInt128::CHSInt128(const UINT32 dwValue)
{
	m_D = m_B = m_C = 0;	
...
{
	UINT32	dwBitAt = ( 0X00000001 << (uIndex % 32 ) );
...
bool CHSInt128::FromStr(const char * lpszValue)
{
	CHSInt128	iTemp;
	string	strSrc = lpszValue;
...
bool CHSInt128::ToStr(std::string &strValue)
{
	CHSInt128	iTemp( *this );
	char	cTarget;
	...
	do
	{
		cTarget = ( (char)((int)( ( iTemp % 10 ).m_A )) + '0' );
