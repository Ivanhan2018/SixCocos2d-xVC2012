...
#define TIMER_CHANNEL_NO -2		// 定时器专用的通道号
#define PROFESSION_CHANNEL_NO -3// 专用的通道号
...
#define MACHINE_CODE_LEN		32		// 机器编号长度
#define GRADE_TITLE_LEN			16		// 等级称号

#define TASK_NAME_LEN			64									// 任务名字长度
#define FILE_NAME_LEN			64									// 文件名字长度
#define ACTIVITY_NAME_LEN		128									// 活动名字长度
#define ACTIVITY_TITLE_LEN		128									// 活动名字长度
#define DESCRIPTION_LEN			256							// 描述长度
#define TIME_LEN				32							// 时间长度
